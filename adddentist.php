...
<head>
    <title>Kwangya Dental | Add Dentist Information</title>
    <meta charset="utf-8">
...
<body>
    <center>
        ...
        <div class="content-section" style="width:55%">
            <h3>Add Dentist Information</h3><br>
            <?php
            if (sizeof($msg) > 0) {
                foreach ($msg as $m) {
                    echo $m;
            ...
            ?>
                ...
                <tr>
                    <th>Name</th>
                    <td><input type='text' id='name' name='name' maxlength="50" placeholder='John Doe' required></td>
                </tr>
                <tr>
                    <th>Age</th>
                ...
                <tr>
                    <th>Sex</th>
                    <td><input list='s' name='s' required>
                        <datalist id='s'>
                            <option value='F'>
                            <option value='M'>
                        </datalist>
                ...
                <tr>
                    <th>Dentist Type</th>
                    <td><input list='types' name='dtype' required>
                        <datalist id='types'>
                ...
                <tr>
                    <th>Clinic</th>
                    <td><input list='clinic' name='clinic' required><datalist id='clinic'>
                            <?php
